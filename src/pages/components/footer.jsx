  ...
  return (
    ...
    justify-center items-center bg-black">
      ...
      gap-y-4 sm:gap-y-4 md:gap-y-4 lg:gap-y-4 xl:gap-y-4 cursor-default">
        <span className="text-2xl font-bold text-yellow-600 flex lg:justify-start lg:items-start">Our Products</span>
        ...
        <span className="text-white flex flex-col justify-center items-center lg:justify-center lg:items-center gap-y-3">
          ...
          <span className="text-white flex flex-row gap-x-5 justify-end items-end">
            ...
            <a href="https://www.tiktok.com/@sandancereals" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faTiktok} className="text-2xl sm:text-2xl md:text-2xl lg:text-2xl xl:text-2xl hover:text-yellow-600 transform transition-transform duration-200 hover:scale-110" />
            </a>
          </span>
        </span>
      </div>
